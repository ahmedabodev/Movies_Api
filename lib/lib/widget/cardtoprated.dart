...
import '../api/getfromapi.dart';
import '../const.dart';
import '../screens/ontop1.dart';


class cardtoprated extends ConsumerWidget {
  @override
  Widget build(BuildContext context,watch) {
    final viewmodelpop=watch(Getdata);
    return  Container(
      height: MediaQuery.of(context).size.height/2.2,
      margin: EdgeInsets.only(top: 15),
      child: viewmodelpop.listdatamodel.isEmpty?Center(child: CircularProgressIndicator()):  ListView.builder(
